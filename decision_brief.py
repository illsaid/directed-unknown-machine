...
def main() -> int:
    ...
    print("- When threshold statements for the same metric use different units or representations, preserve each supplied statement and leave equivalence unresolved unless the contract supplies the conversion rule or explicitly states the equivalence; do not introduce a hidden normalization step.")
    return 0
