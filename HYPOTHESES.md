...
**Next test:** Test a direct observed scope difference whose relevance to the target decision population is uncertain, checking whether the assignment preserves the observation without treating relevance as established.
...
**Evidence against:** The current repo has no real external tool under test except itself. Runs 5 through 29 produced their useful result by shaping, rejecting, repairing, preserving, bounding, clarifying, consistency-checking, evidence-binding, or provenance-preserving decision notes, not by offering a general failure explanation.
