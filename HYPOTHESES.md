...
**Next test:** Repair an unsupported field whose meaning belongs under Evidence rather than Success, preserving its wording, and verify that the resulting brief does not recast an observation as a requirement.
...
**Evidence against:** The current repo has no real external tool under test except itself. Runs 5 through 13 produced their useful result by shaping, rejecting, repairing, verifying, preserving, or validating decision notes, not by offering a general failure explanation.
