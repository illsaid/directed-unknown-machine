...
**Evidence against:** The current repo has no real external tool under test except itself. Runs 5 through 17 produced their useful result by shaping, rejecting, repairing, preserving, bounding, or clarifying decision notes, not by offering a general failure explanation.
