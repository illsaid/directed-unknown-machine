...
**Evidence against:** The current repo has no real external tool under test except itself. Runs 5 through 11 produced their useful result by shaping, rejecting, repairing, verifying, preserving, or validating decision notes, not by offering a general failure explanation.
