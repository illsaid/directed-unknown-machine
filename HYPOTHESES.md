...
**Next test:** Supply conflicting evidence about whether a governance exception applies, testing whether supplied applicability authority is required before either exception status can govern.
...
**Evidence against:** Runs 5–148 produced useful results by shaping and auditing decision contracts, not by providing general failure explanations.
