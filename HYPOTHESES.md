...
**Next test:** Test a supported sensitivity range that remains entirely on one side of the threshold, verifying that uncertainty does not automatically make a resolvable gate unresolved.
