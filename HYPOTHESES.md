...
**Next test:** Test the strict minimum counterpart: a supported range whose lower bound equals a threshold stated as “above,” verifying that equality violates a strict minimum.
...
**Evidence against:** The current repo has no real external tool under test except itself. Runs 5 through 39 produced their useful result by shaping, rejecting, repairing, preserving, bounding, clarifying, consistency-checking, evidence-binding, provenance-preserving, applicability-auditing, or sensitivity-bounding decision notes, not by offering a general failure explanation.
