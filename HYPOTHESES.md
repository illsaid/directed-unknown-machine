...
**Next test:** Test two evidence sources with overlapping measurements, verifying that overlap is disclosed without being counted as independent corroboration while genuinely distinct measurements remain distinct.
...
**Evidence against:** The current repo has no real external tool under test except itself. Runs 5 through 24 produced their useful result by shaping, rejecting, repairing, preserving, bounding, clarifying, consistency-checking, evidence-binding, or provenance-preserving decision notes, not by offering a general failure explanation.
